...
<div class="p-8">
	<div class="page-header">
		...
		<p class="text-gray-600 dark:text-gray-400 mt-1">Configure system settings</p>
	</div>

	{#if saved}
		<Alert variant="success" class="mb-6" dismissible>Settings saved successfully!</Alert>
	{/if}
	...
	<div class="space-y-6">
		...
		<Card>
			...
			<div class="space-y-4">
				...
				<Alert variant="info">Configure email provider settings in environment variables.</Alert>
			</div>
		</Card>
