...
<div class="p-8">
  <div class="page-header flex items-center justify-between">
    ...
    <Button variant="primary" onclick={() => goto('/roles/create')}>
      + Create Role
    </Button>
  </div>
      ...
      <Card>
        <div class="flex items-start justify-between mb-4">
          <div class="flex-1">
            ...
            {#if role.isSystem}
              <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 mt-1">
                System Role
              </span>
            {/if}
          </div>
